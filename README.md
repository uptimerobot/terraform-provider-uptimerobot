...
If you wish to work on the provider, you'll first need [Go](https://golang.org/doc/install) installed on your machine. Use the version declared in `go.mod` (currently 1.27.1), which is also what CI uses.
